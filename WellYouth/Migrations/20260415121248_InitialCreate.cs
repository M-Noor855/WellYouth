        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Guidelines = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WellnessActivities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetFrequency = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthHabits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthHabits_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthScoreEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthScoreEntries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StatType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthStats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "SpecialistContactRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialistContactRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecialistContactRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SpecialistContactRequests_Specialists_SpecialistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserActivityLogs_WellnessActivities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "WellnessActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SafetyCategory = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "HealthHabitLogs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HealthHabitId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthHabitLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthHabitLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HealthHabitLogs_HealthHabits_HealthHabitId",
                        column: x => x.HealthHabitId,
                        principalTable: "HealthHabits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityGroupMembers_GroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthHabitLogs_HealthHabitId_LogDate",
                table: "HealthHabitLogs",
                columns: new[] { "HealthHabitId", "LogDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HealthHabitLogs_UserId",
                table: "HealthHabitLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthHabits_UserId",
                table: "HealthHabits",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthScoreEntries_UserId",
                table: "HealthScoreEntries",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthStats_UserId",
                table: "HealthStats",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecialistContactRequests_SpecialistId",
                table: "SpecialistContactRequests",
                column: "SpecialistId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecialistContactRequests_UserId",
                table: "SpecialistContactRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Specialists_Specialty",
                table: "Specialists",
                column: "Specialty");

            migrationBuilder.CreateIndex(
                name: "IX_UserActivityLogs_ActivityId",
